...
class Handler extends ExceptionHandler
{
    ...
    public function handleException(Throwable $e): JsonResponse
    {
        ...
        if ($e instanceof ModelNotFoundException) {
            return $this->errorResponse("Record not exists", Response::HTTP_NOT_FOUND);
        }
        ...
        if (config('app.debug')) {
            return $this->dataResponse("{$e->getMessage()} on {$e->getFile()} @ {$e->getLine()}");
        }

        return $this->errorResponse('Server Error. Please try again later.', Response::HTTP_INTERNAL_SERVER_ERROR);
    }
}
